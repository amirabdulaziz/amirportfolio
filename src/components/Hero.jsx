...
<section className="hero-bg mt-[-95px] min-h-screen  px-auto" id="home">
  <div className="overflow-hidden pt-20">
    ...
    <ParticleBackground /> */}
    <div
      className="  container min-h-[90vh] max-w-[115vh] flex flex-col-reverse md:grid md:grid-cols-2 md:flex-cols-2 md:justify-center gap-2 antialiased max-w-[120vh] md:items-center mx-auto pb-20">
      <div className="flex flex-col px-2 justify-center items-right">
        <div className="">
          <h1 className="md:text-3xl sm:text-2xl text-2xl font-bold inline-flex m-2 text-left">
            <TypeAnimation sequence={[ "Software engineer" , 1000, "Web & mobile developer" , 1000, "Software tester" ,
